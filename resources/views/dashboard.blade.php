<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 flex items-start space-x-3">
            ...
            <div>
                ...
                <p class="text-amber-700 text-sm mt-1">Akun Anda sedang dalam proses peninjauan oleh Admin. Anda belum dapat mengelola atau mendaftarkan UMKM sebelum akun disetujui. Silakan hubungi Admin jika butuh bantuan.</p>
            </div>
        </div>
        @endif
