<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4" x-data="{ show: false }">
            ...
            <div class="relative">
                <input id="password" :type="show ? 'text' : 'password'" name="password" required
                       class="w-full rounded-lg border-gray-300 focus:border-kauman-primary focus:ring-kauman-primary pr-10">
                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700">
        ...
        <button type="submit" class="w-full bg-kauman-primary text-white py-3 rounded-lg font-semibold hover:bg-kauman-primary-dark transition-colors">Daftar Akun</button>
    </form>
